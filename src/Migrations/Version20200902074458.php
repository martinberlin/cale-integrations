...
final class Version20200902074458 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE app_user_api_gallery (user_id INT NOT NULL, user_api_id VARCHAR(40) NOT NULL, image_id INT NOT NULL, caption VARCHAR(255) NOT NULL, position INT NOT NULL, INDEX IDX_97302469A76ED395 (user_id), INDEX IDX_9730246931C42205 (user_api_id), UNIQUE INDEX user_api_name_idx (user_id, user_api_id), PRIMARY KEY(user_id, user_api_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
